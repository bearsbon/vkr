  ...
  return (
    ...
    props.search.map((user, index) => (
      <div key={user} className="employee">
            ...
            <div className="content overflow-scroll overflow-x-hidden">
              <div className="left mx-auto">
                ...
                <div className="font-medium leading-[40px] text-[19px]">
                  <span className=" text-sky-800 mr-5 font-semibold ">
                    Возраст:
                  </span>
                  {user.age}
                </div>
        ...
        <div className="w-12 h-12 rounded-full ml-1 mr-5 border-[2px] border-sky-700 flex">
          <img
            className="employee_avatar m-auto w-[40px] h-[40px] object-cover object-top rounded-full"
            src={user.avatar}
            alt="ava"
          />
        </div>
